...
class HimiUserBotClient(TelegramClient):
    def himi_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**HimiUserbot Error report**\n\n"
                        link = "[here](https://t.me/hosthejosh)"
            ...
            if pattern is not None:
                ...
                if edited:
                    Himiub.add_event_handler(func, events.MessageEdited(**kwargs))
                Himiub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                Himiub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                Himiub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
HimiUserBotClient.fast_download_file = download_file
HimiuserBotClient.fast_upload_file = upload_file
HimiUserBotClient.reload = restart_script
HimiUserBotClient.get_msg_link = get_message_link
HimiUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    HimiUserBotClient.send_message = send_message
    HimiUserBotClient.send_file = send_file
    HimiUserBotClient.edit_message = edit_message
